...
import "swiper/css";
import { Brain, Target, Activity } from "lucide-react"; // icônes pour la 2e section
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <blockquote className="relative">
            ...
            <footer className="mt-4 text-sm text-gray-400">
              Jean Fournier – <em>Les cahiers de l’INSEP n°22</em>, 1998
            </footer>
          </blockquote>
        </div>
      </section>
...
<section id="etapes" className="py-16 mb-16">
  ...
  <div className="grid gap-6 md:gap-8 md:grid-cols-3">
    ...
    {/* Préparateur physique & équipe médicale */}
    <div className="p-6 rounded-xl shadow-md bg-white/70  text-center">
